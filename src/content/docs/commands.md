...
|:-|:-:|:-|
|rain-maker|25|use rain sound|
|thunder-god|50|use thunder sound|
...
|bams|0|bespoke. artisinal. hardcrafted. meme. software.|
...
|gifta-vip|0|transfer your giga-vip to another user|
|duel|0|starts a duel with another user (must be as a reply)|
|jill|2|send a message to jill, she will always respond|
|tts| market value |use tts|
|tts-price|0|prints the current market-value price of tts |
|my-voice|0|sets your default tts voice|
...
|choose|0|randomly select from a list of provided options|
|coin|0|flips a fair coin|
|gaslight| market value | self documenting (obvious)|
|my-color|0|gets your configured color|
|set-color|0|attempts to set your configured color (must be unique among all users)|
...
|command|0|gets a link to this page|
