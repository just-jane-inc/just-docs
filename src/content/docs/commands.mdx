...
| command        | description                                          |
|:---------------|:-----------------------------------------------------|
| `!fish [bait]` | test your luck and cast a line                       |
| `!fish <id>`   | [chase your fish](/bahms/fishing/#chasing-your-fish) |

<Aside type="tip">
    Be sure to have a <RedeemLink id={RedeemID.FishingRod}>rod redeemed</RedeemLink>.
</Aside>
