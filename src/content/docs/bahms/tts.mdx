...
<Aside type="note">
    TTS is only available to followers to discourage abuse. You must be following for some time to be able to use TTS.
</Aside>
...
The current market price for TTS is <MarketPrice product="tts" unit="gv" />.
