...
The current market price is set to <MarketPrice product="jill" unit="gv" />.
...
<RedeemLink id={RedeemID.SayHeyJill} /> redeem
or using the `!jill` command:

| command       |                  cost ([gv](/giga-vip/))                  | description            |
|:--------------|:---------------------------------------------------------:|:-----------------------|
| `!jill <msg>` | <MarketPrice product="jill" unit="gv" showUnit={false} /> | Talk to jill.          |
