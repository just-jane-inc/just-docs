...
Using the Text-to-Speech (TTS) system gives you a way to cut through the spam and maybe even be heard.
Bless us with your wit using the `!tts` command.
...
Please try to avoid being extremely vulgar with the TTS.
Remember that the stream should be PG-13.
...
You can either start your `!tts` message with `[voice]`, using the provided voice for that message or use the `!my-voice <voice>` command to select a new
default.
