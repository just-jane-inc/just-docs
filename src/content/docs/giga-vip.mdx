...
Clocking in using the [clock-in redeem](/redeems/#just-clock-in) will give you [`floor(log2(<clock-ins>))`](https://www.wolframalpha.com/input?i=floor%28log2%28n%29%29+for+1+to+127) Giga VIP.
...
Clocking out using the [clock-out redeem](/redeems/#just-clock-out) will give
...
Giga-vip and other information can be found on [usercards](https://bahms.org/usercard/).
